                    ...
                    <div class="card">
                       ...
                       Supplier Details
                        ...
                        <div class="card-body">
                            ...
                            $str .= "<thead><tr><th>Supplier ID</th><th>Supplier Name</th><th>Supplier Email</th><th>Supplier Mobile</th><th>Supplier Address</th></tr></thead><tbody>";
                            while ($row = $res->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                //$str .= "<td> <a href=AddSupplier.php?Supplier Id=" . $row['Supplier_Id'] . ">Edit</a></td>";
                                $str .= "</tr>";
                            }
                            echo $str;
                            echo "</tbody></table>";
